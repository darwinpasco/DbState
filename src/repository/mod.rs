...
pub(crate) use objects::{
    ...
    grant_grantee_file_token, index_file_path, materialized_view_file_path,
    object_ref_from_relative_path, safe_file_component, schema_file_path, sequence_file_path,
    table_file_path, trigger_file_path, view_file_path, ObjectRef,
};
